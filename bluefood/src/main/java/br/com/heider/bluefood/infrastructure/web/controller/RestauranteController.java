...
import br.com.heider.bluefood.aplication.service.RelatorioService;
...
import br.com.heider.bluefood.domain.pedido.RelatorioItemFaturamento;
import br.com.heider.bluefood.domain.pedido.RelatorioItemFilter;
import br.com.heider.bluefood.domain.pedido.RelatorioPedidoFilter;
...
public class RestauranteController {
	...
	public String cadastrar(@Valid @ModelAttribute("itemCardapio") ItemCardapio itemCardapio, Errors erros,
			Model model) {
	...
	public String proximoPedido(@RequestParam("pedidoId") Integer pedidoId, Model model) {
	...
	public String relatorioItens(@ModelAttribute("relatorioIemPedido") RelatorioItemFilter filter, Model model) {
		...
		List<RelatorioItemFaturamento> itensCalculados = relatorioService.calcularFaturamentoItens(restauranteId,
				filter);
